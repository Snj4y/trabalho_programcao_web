...
.input-box input:hover {
    background-color: #9c9c9cda;
}

.input-box input:focus-visible {
    outline: 1px solid #ffb168da;
}
...
.cardp:hover .card-image img {
    transform: scale(1.02)
               rotate(-3deg)
               translateX(-5px);
}

.cardp .card-image .bx-star {
    cursor: pointer;
    position: absolute;
    top: 12px;
    right: 12px;
